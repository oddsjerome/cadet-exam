...
<template>
    <div class="flex gap-2">
        <div class="flex items-center w-full">
            ...
            </label> <input type="search" name="search-input" id="search-input" placeholder="Starbucks product"
                v-model="query" class="py-2 px-4 border-y border-r rounded-r-full outline-none w-full">
        </div>
